  ...
  return (
    <div className="container px-4 py-12 md:px-6 md:py-24 bg-black">
      ...
      <div className="mb-12 overflow-hidden rounded-lg">
        <img src={project.fullImage || "/placeholder.svg"} alt={project.title} className="w-full object-cover" />
      </div>
      ...
      <div className="mb-12 space-y-8">
        <div className="space-y-4">
          ...
          <p className="leading-relaxed text-zinc-400">{project.content.overview}</p>
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Challenge</h2>
          <p className="leading-relaxed text-zinc-400">{project.content.challenge}</p>
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Solution</h2>
          <p className="leading-relaxed text-zinc-400">{project.content.solution}</p>
        </div>
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-white">Outcome</h2>
          <p className="leading-relaxed text-zinc-400">{project.content.outcome}</p>
        </div>
