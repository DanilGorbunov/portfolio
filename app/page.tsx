      ...
      <section className="min-h-screen flex items-center justify-center px-6" style={{ position: 'relative', zIndex: 10 }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl font-light opacity-50 mt-2 md:mt-4">
              Product Designer / Developer +AI
            </p>
            <p className="text-lg md:text-xl font-light opacity-70 max-w-2xl mx-auto leading-relaxed mt-6 md:mt-12">
              Creating digital experiences that merge<br />
              intuitive design with real business impact
            </p>
            <p className="text-sm font-light opacity-30 mt-3 md:mt-10">
              Bratislava, Slovakia
            </p>
